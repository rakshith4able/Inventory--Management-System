...
$chairs=mysqli_fetch_all($r1,MYSQLI_ASSOC);
 ...
 ?>
  ...
  <div class="main">
    <div class="forms" style="width:60vw;height:25vw;margin-top:5vw;border: none;;overflow-y:scroll;margin-left:20%;background-color:rgba(255, 255, 255, 0.5);  ">
    <form >
      <table >
      <tr id="first">
        <td>Chair no</td>
